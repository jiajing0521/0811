...
<div id="allGame">
    ...
    <!--起跑线-->
    <img src="img/racing.png" alt="" class="racing">
...
//                    if (this.x+this.w >= position.x-10 && this.x<= position.x + position.w + 10 && this.y+this.h >= position.y - 10 && this.y >= position.y + position.h + 10) {
        ...
        function checkP(obj1, obj2) {
            //x轴方向最小距离
            var disX = obj1.w/2 + obj2.w/2-12;
            //y轴
            var disY = obj1.h/2 + obj2.h/2-12;
...
<script>
    ...
    wx.ready(function () {
        wx.onMenuShareTimeline({
            title: '你的好友'+'<?php echo $nickname;?>'+'正在玩旋风赛车，快来帮他晋级吧！！！', // 分享标题
            link: 'http://wangjjsvn.applinzi.com/xuanfengsaiche/share.php?openid='+'<?php echo $openid;?>'+'&nickname='+'<?php echo $nickname;?>', // 分享链接
            imgUrl: 'http://wangjjsvn.applinzi.com/xuanfengsaiche/img/logo1.jpg', // 分享图标
            success: function () {
