        ...
        <div class="content-box">
            ...
            <div class="content-box-content">
                <div class="tab-content default-tab" id="tab1">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Icons -->
                                <a href="http://localhost/phpLearn/phpSaturday/update.php?id=<?php echo $value['id'];?>&name=<?php echo $value['name'];?>&gender=<?php echo $value['gender'];?>&birthday=<?php echo $value['birthday'];?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" />
                                </a>
                                <a href="http://localhost/phpLearn/phpSaturday/delete.php?id=<?php echo $value['id'];?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" />
                                </a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                ...
                <div class="tab-content" id="tab2">
                    <form action="http://localhost/phpLearn/phpSaturday/add.php" method="post">
                        <fieldset>
