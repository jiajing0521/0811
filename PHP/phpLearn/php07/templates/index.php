                ...
                <div class="tab-content default-tab" id="tab1">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Icons -->
                                <a href="<?php echo BASE_URL.'update.php?id='.$value['id'];?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                                <a href="<?php echo BASE_URL.'delete.php?id='.$value['id'];?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
