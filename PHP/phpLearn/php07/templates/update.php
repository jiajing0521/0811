    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="profile-links"> Hello, <a href="#" title="Edit your profile">865171</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
                <br />
                <a href="#" title="View the Site">View the Site</a> | <a href="<?php echo BASE_URL.'logout.php';?>" title="Sign Out">Sign Out</a> </div>
            <ul id="main-nav">
                <!-- Accordion Menu -->
                ...
                <div class="tab-content default-tab" id="tab2">
                    <form action="<?php echo BASE_URL.'update.php';?>" method="post">
                        <fieldset>
                            ...
                            <p>
                                <label>标题</label>
                                <input class="text-input small-input" type="text" id="small-input" name="title" value="<?php echo $dataArray['title'];?>"/>
                                <br />
                                <small>请输入新标题</small> </p>
                            <p>
                                <label>内容</label>
                                <textarea class="text-input textarea wysiwyg" id="textarea" name="content" cols="79" rows="15"><?php echo $dataArray['content'];?></textarea>
                            </p>

                            <input class="text-input small-input" type="hidden" id="small-input" name="id" value="<?php echo $dataArray['id'];?>"/>
