    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="profile-links"> Hello, <a href="#" title="Edit your profile">865171</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
                <br />
                <a href="#" title="View the Site">View the Site</a> | <a href="<?php echo BASE_URL.'index.php?c=admin&a=logout&admin=1';?>" title="Sign Out">Sign Out</a> </div>
            <ul id="main-nav">
                <!-- Accordion Menu -->
        ...
        <div class="content-box">
            ...
            <div class="content-box-content">
                ...
                <div class="tab-content default-tab" id="tab2">
                    <form action="<?php echo BASE_URL.'index.php?c=news&a=update&admin=1'?>" method="post">
                        <fieldset>
                            ...
                            <input class="text-input small-input" type="hidden" id="small-input" name="id" value="<?php echo $id;?>"/>
                            <p>
                                <label>内容</label>
