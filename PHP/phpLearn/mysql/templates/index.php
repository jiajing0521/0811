    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="profile-links"> Hello, <a href="#" title="Edit your profile">865171</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
                <br />
                <a href="#" title="View the Site">View the Site</a> | <a href="http://localhost/phpLearn/mysql/logout.php" title="Sign Out">退出</a> </div>
            <ul id="main-nav">
                <!-- Accordion Menu -->
        ...
        <div class="content-box">
            ...
            <div class="content-box-content">
                ...
                <div class="tab-content" id="tab2">
                    <form action="http://localhost/phpLearn/mysql/add.php" method="post">
                        <fieldset>
